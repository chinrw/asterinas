...
#  - ATTACH_TEST_DISKS: "true" or "false"; only applies to the normal runner;
...
ATTACH_TEST_DISKS=${ATTACH_TEST_DISKS:-"true"}
...
Q35_TEST_DISK_DEVICE_ARGS=""
NVME_TEST_DISK_DEVICE_ARGS=""
if [ "$1" != "normal" ] || [ "$ATTACH_TEST_DISKS" = "true" ]; then
    Q35_TEST_DISK_DEVICE_ARGS="\
    ...
    "
    NVME_TEST_DISK_DEVICE_ARGS="-device nvme,drive=nvme0n1,serial=nvme0n1"
fi
